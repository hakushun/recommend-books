...
import { BookRegisterModal, Props } from '../BookRegisterModal';

export default {
  title: 'molecules/BookRegisterModal',
  component: BookRegisterModal,
} as Meta;

const Template: Story<Props> = (args) => <BookRegisterModal {...args} />;
