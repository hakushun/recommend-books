...
import { CreateBookButton, Props } from '../CreateBookButton';

export default {
  title: 'atoms/CreateBookButton',
  component: CreateBookButton,
} as Meta;

const Template: Story<Props> = (args) => <CreateBookButton {...args} />;
